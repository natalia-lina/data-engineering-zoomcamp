...
Management Commands:
  ...
  compose*    Docker Compose (Docker Inc., v2.24.1)
...
Global Options:
  ...
  -l, --log-level string   Set the logging level ("debug", "info", "warn", "error",
      ...
      --tlscacert string   Trust certs signed only by this CA (default
                           "/home/shipa/.docker/ca.pem")
      --tlscert string     Path to TLS certificate file (default
                           "/home/shipa/.docker/cert.pem")
      --tlskey string      Path to TLS key file (default "/home/shipa/.docker/key.pem")
...
Options:
  ...
  -e, --env list                         Set environment variables
      ...
      --health-start-interval duration   Time between running the check during the
                                         start period (ms|s|m|h) (default 0s)
  ...
  -i, --interactive                      Keep STDIN open even if not attached
      --io-maxbandwidth bytes            Maximum IO bandwidth limit for the system
                                         drive (Windows only)
...
So version of the package *wheel* is 0.42.0
